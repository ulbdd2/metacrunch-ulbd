...
class Metacrunch::ULBD::Record
  ...
  DATAFIELDS = [
    ...
    { tags: ["E21"],                   accessor: "Angaben zum Inhalt",                                   type: AngabeZumInhalt },
    { tags: ["C03"], ind1: ["-"],      accessor: "bevorzugte Titel des Werkes",                          type: BevorzugterTitelDesWerkes },
    { tags: ["C03"], ind1: ["t"],      accessor: "in Beziehung stehende Werke",                          type: BevorzugterTitelDesWerkes },
    { tags: ["C62"],                   accessor: "Manifestationstitel von weiteren verkörperten Werken", type: ManifestationstitelVonWeiterenVerkörpertenWerken },
