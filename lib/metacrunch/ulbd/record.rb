...
class Metacrunch::ULBD::Record
  ...
  DATAFIELDS = [
    ...
    { tags: ["E21"],                   accessor: "Angaben zum Inhalt Os",                                type: AngabeZumInhalt },
    { tags: ["C03"], ind1: ["-"],      accessor: "bevorzugte Titel des Werkes Os",                       type: BevorzugterTitelDesWerkes },
    { tags: ["C03"], ind1: ["t"],      accessor: "in Beziehung stehende Werke Os",                       type: BevorzugterTitelDesWerkes },
