...
class Metacrunch::ULBD::Record
  ...
  DATAFIELDS = [
    ...
    { tags: (104..196).step(4), ind1: ["-", "a", "b", "c", "e", "f"], ind2: ["1", "2"],       accessor: "Personen2",                                            type: Person },
    { tags: (204..296).step(4), ind1: ["-", "a", "b", "c", "e"], ind2: ["1", "2"],       accessor: "Körperschaften2",                                      type: Körperschaft },
