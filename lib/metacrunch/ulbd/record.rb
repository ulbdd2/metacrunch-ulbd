...
class Metacrunch::ULBD::Record
  ...
  DATAFIELDS = [
    ...
    { tags: (104..196).step(4),        accessor: "Personen2",                                            type: Person },
    { tags: (204..296).step(4),        accessor: "Körperschaften2",                                       type: Körperschaft },
    { tags: ["100"], ind2: ["1", "2"], accessor: "Personen",                                            type: Person },
    { tags: ["200"], ind2: ["1", "2"], accessor: "Körperschaften",                                       type: Körperschaft },
