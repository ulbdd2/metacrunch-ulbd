  ...
  def location
    ...
    source.datafields('LOC').each do |field|
      ...
      locationname = case
        ...
        when (field_b == '18') then 'Rara Sonderlesesaal'
        when (field_b == '19') then 'Rara Sonderlesesaal'
        when (field_b == '20') then 'Zentralbibl. Sonderlesesaal'
        when (field_b == '21') then 'Rara Sonderlesesaal'
        when (field_b == '24') then 'Rara Sonderlesesaal'
        when (field_b == '25') then 'VB Geisteswissenschaften II'
        when (field_b == '27') then 'VB Geisteswissenschaften II'
        ...
        when (field_b == '37') then 'VB Geisteswissenschaften II'
...
#=begin    
      ...
      field_g = field.subfields('g').value
        ...
        when (field_g == '18') then 'Rara Sonderlesesaal'
        when (field_g == '19') then 'Rara Sonderlesesaal'
        when (field_g == '20') then 'Zentralbibl. Sonderlesesaal'
        when (field_g == '21') then 'Rara Sonderlesesaal'
        when (field_g == '24') then 'Rara Sonderlesesaal'
        when (field_g == '25') then 'VB Geisteswissenschaften II'
        when (field_g == '27') then 'VB Geisteswissenschaften II'
        when (field_g == '28') then 'Magazin Geisteswissenschaften'
        when (field_g == '29') then 'VB Geisteswissenschaften II'
        when (field_g == '30') then 'VB Geisteswissenschaften II'
        when (field_g == '31') then 'VB Geisteswissenschaften II'
        when (field_g == '32') then 'Magazin Geisteswissenschaften'
        when (field_g == '33') then 'Magazin Geisteswissenschaften'
        when (field_g == '35') then 'VB Geisteswissenschaften II'
        when (field_g == '37') then 'VB Geisteswissenschaften II'
