  ...
  def location
    ...
    source.datafields('LOC').each do |field|
      ...
      locationname = case
        ...
        when (field_b == '28') then 'VB Geisteswissenschaften I'
        ...
        when (field_b == '32') then 'VB Geisteswissenschaften I'
        when (field_b == '33') then 'VB Geisteswissenschaften I'
...
#=begin    
      ...
      field_g = field.subfields('g').value
        ...
        when (field_g == '28') then 'VB Geisteswissenschaften'
        ...
        when (field_g == '32') then 'VB Geisteswissenschaften'
        when (field_g == '33') then 'VB Geisteswissenschaften'
