...
class Metacrunch::ULBD::Transformations::MabToVufind::AddTitleSimple < Metacrunch::Transformator::Transformation::Step
  include parent::Helpers::Datafield089
  include parent::Helpers::Merge

  def call
    target ? Metacrunch::Hash.add(target, "title_simple", title) : title
  end
