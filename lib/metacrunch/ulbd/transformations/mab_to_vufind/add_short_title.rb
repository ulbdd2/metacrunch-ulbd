...
class Metacrunch::ULBD::Transformations::MabToVufind::AddShortTitle < Metacrunch::Transformator::Transformation::Step
  ...
  def short_title
    ...
    .try do |_short_title|
      _short_title.strip.presence
    end
    .try do |_cleaned_short_title|
      _cleaned_short_title[0].upcase << _cleaned_short_title[1..-1]
    end
  end
end
