...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddCreatorContributorSearch < Transformator::Transformation::Step
  def call
    target ? MightyHash.add(target, "creator_contributor_search", creator_contributor_search) : creator_contributor_search
  end
