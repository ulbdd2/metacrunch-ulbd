...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddTitleDisplay < Transformator::Transformation::Step
  include parent::Helpers::Datafield089

  def call
    target ? MightyHash.add(target, "title_display", title_display) : title_display
  end
