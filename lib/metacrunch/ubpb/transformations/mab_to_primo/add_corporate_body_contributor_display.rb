...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddCorporateBodyContributorDisplay < Transformator::Transformation::Step
  include parent::Helpers::CorporateBodyFromField
  
  def call
    target ? MightyHash.add(target, "corporate_body_contributor_display", corporate_body_contributor_display) : corporate_body_contributor_display
  end
