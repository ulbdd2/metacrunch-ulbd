...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddSecondaryFormSuperorder < Transformator::Transformation::Step
  def call
    target ? MightyHash.add(target, "secondary_form_superorder", secondary_form_superorder) : secondary_form_superorder
  end
