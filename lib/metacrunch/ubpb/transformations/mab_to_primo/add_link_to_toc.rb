...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddLinkToToc < Transformator::Transformation::Step
  def call
    target ? MightyHash.add(target, "link_to_toc", link_to_toc) : link_to_toc
  end
