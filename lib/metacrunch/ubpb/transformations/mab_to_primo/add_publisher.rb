...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddPublisher < Transformator::Transformation::Step
  def call
    target ? MightyHash.add(target, "publisher", publisher) : publisher
  end
