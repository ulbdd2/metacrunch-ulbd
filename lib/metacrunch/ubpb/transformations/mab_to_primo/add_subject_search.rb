...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddSubjectSearch < Transformator::Transformation::Step
  def call
    target ? MightyHash.add(target, "subject_search", subject_search) : subject_search
  end
