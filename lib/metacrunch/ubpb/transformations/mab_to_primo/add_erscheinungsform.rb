...
class Metacrunch::UBPB::Transformations::MabToPrimo::AddErscheinungsform < Transformator::Transformation::Step
  def call
    target ? MightyHash.add(target, "erscheinungsform", erscheinungsform) : erscheinungsform
  end
