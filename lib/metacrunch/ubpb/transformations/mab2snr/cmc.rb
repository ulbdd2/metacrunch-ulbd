    ...
    module Transformations
      module MAB2SNR
        ...
        private
          ...
          def content
            "zzz" # unspecified for non-RDA records
          end
          ...
          def carrier
            @carrier ||= begin
              ...
              case
                # Druckschrift
                when ["a"].include?(p0) then "nc" # Nicht spezifiziert => Band

                # Handschrift
                when ["a"].include?(p1) then "nc" # Nicht spezifiziert => Band
                ...
                # Spiele
                when ["a"].include?(p9) then "nz" # Nicht spezifiziert => other unmediated carrier
